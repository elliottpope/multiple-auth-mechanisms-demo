package elliott.pope.authmechanisms.utils;
...
public class CertificateUtils {
    ...
    public static X509Certificate generate(final String cn,
                                           final int days)
            throws OperatorCreationException, CertificateException, CertIOException, NoSuchProviderException, NoSuchAlgorithmException {
        final KeyPairGenerator keyPairGenerator = KeyPairGenerator.getInstance("RSA");
        final KeyPair keyPair = keyPairGenerator.generateKeyPair();
        return generate(keyPair, "SHA256WithRSA", cn, days);
    }
